...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "xingfuqiu"
  # s.authors            = { "xingfuqiu" => "xingfuqiu@gmail.com" }
  # s.social_media_url   = "http://twitter.com/xingfuqiu"
  ...
  s.source_files  = "CheckUpdateMgrDemo/CheckVersionMgr/*"
